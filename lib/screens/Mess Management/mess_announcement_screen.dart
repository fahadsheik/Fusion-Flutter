...
import '../Examination/examination_dashboard.dart'; // Import the new bottom bar component

class MessAnnouncementScreen extends StatefulWidget {
  const MessAnnouncementScreen({super.key});

  @override
  State<MessAnnouncementScreen> createState() => _MessAnnouncementScreenState();
}

class _MessAnnouncementScreenState extends State<MessAnnouncementScreen> {
