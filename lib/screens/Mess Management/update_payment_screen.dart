...
class _UpdatePaymentScreenState extends State<UpdatePaymentScreen> {
  ...
  final List<String> _tabs = ['Update Balance Requests', 'Request Status'];

  Widget updateBalanceRequests() {
    return Column(
      children: [
        _buildTextFormField(
        ...
        _buildDatePickerFormField(
            label: 'Payment Date *', controller: paymentDateController),
