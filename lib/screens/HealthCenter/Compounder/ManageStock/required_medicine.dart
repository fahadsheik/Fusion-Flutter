...
class RequiredMedicine extends StatefulWidget {
  const RequiredMedicine({super.key});

  @override
  State<RequiredMedicine> createState() => _RequiredMedicineState();
}

class _RequiredMedicineState extends State<RequiredMedicine> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final TextEditingController _searchController = TextEditingController();

  // Dummy data for Required medicines
