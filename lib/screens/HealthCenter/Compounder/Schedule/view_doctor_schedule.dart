...
class ViewDoctorSchedule extends StatefulWidget {
  const ViewDoctorSchedule({super.key});

  @override
  State<ViewDoctorSchedule> createState() => _ViewDoctorScheduleState();
}

class _ViewDoctorScheduleState extends State<ViewDoctorSchedule> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  final List<Map<String, String>> _scheduleData = [
    {
      'doctorName': 'Dr GS Sandhu',
