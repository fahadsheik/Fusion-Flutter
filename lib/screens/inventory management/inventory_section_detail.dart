...
import 'inventory_section_screen.dart';

class InventorySectionDetailScreen extends StatefulWidget {
  final String section;
  
  const InventorySectionDetailScreen({
    super.key,
    required this.section,
  });

  @override
  State<InventorySectionDetailScreen> createState() => _InventorySectionDetailScreenState();
}

class _InventorySectionDetailScreenState extends State<InventorySectionDetailScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final TextEditingController _searchController = TextEditingController();
  String _selectedFilter = 'All';
  
  // Sample data for the section inventory
  late final List<Map<String, dynamic>> _inventoryData;
  List<Map<String, dynamic>> _filteredData = [];
  
  @override
  void initState() {
    super.initState();
    // Initialize with section-specific data
    if (widget.section == 'VASISTHA HOSTEL') {
      _inventoryData = [
        {
          'product': 'Beds',
          'productId': 'BD001',
