...
import '../screens/other_academic_procedures/other_academic_procedures_dash.dart';
...
class _ModulesScreenState extends State<ModulesScreen>
  ...
  final List<Module> _modules = [
    ...
    Module(
        id: '16',
        title: 'Other Academic Procedures',
  ...
  Widget _buildRecentModuleItem(Module module) {
    ...
    return InkWell(
      onTap: () {
        ...
        } else if (module.id == '16') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const OtherAcademicProceduresDashboard(),
            ),
          );
        } else {
                      ...
                      Future.delayed(const Duration(milliseconds: 300), () {
                        ...
                        if (widget.module.id == '1') {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  const OtherAcademicProceduresDashboard(),
                            ),
                          );
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
