...
import '../screens/HR/hrdashbord.dart'; // Added HR Dashboard import
import '../screens/HR/leave_page.dart';
import '../screens/HR/ltc_page.dart';
import '../screens/HR/CpdaAdvanceFormScreen.dart';
import '../screens/HR/CpdaClaim.dart';
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // Programme and Curriculum Module - Updated to show "module removed" message
                  _buildModuleWithToggle(
                    ...
                    onTap: () {
                      // Show a message that the module has been removed
                      Navigator.pop(context);
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              'Programme & Curriculum module has been removed'),
                          duration: const Duration(seconds: 2),
                  ...
                  _buildModuleWithToggle(
                    ...
                    onTap: () {
                      // Navigate to HR Dashboard when clicking on the module directly
                      Navigator.pop(context);
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  if (_isHumanResourcesExpanded) ...[
                    _buildSubNavItem(context,
                        ...
                        index: 41),
                    _buildSubNavItem(context,
                        icon: Icons.flight, title: 'LTC', index: 40),
                    _buildSubNavItem(context,
