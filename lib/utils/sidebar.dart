...
class _SidebarState extends State<Sidebar> {
  ...
  bool _isSpacsExpanded = false; // Ensure this is initialized
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildModuleWithToggle(
                  icon: Icons.account_balance,
                  title: 'SPACS',
                  isExpanded: _isSpacsExpanded,
                  onToggle: () {
                    setState(() {
                      _isSpacsExpanded = !_isSpacsExpanded;
                      if (_isSpacsExpanded) {
                        // Scroll to SPACS section when expanded
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SpacsDashboard()),
                    );
                  },
                ),
                if (_isSpacsExpanded) ...[
                  ...
                  _buildSubNavItem(context,
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const BrowseApplicationsPage()),
                    );
                  }),
                  _buildSubNavItem(context,
                  ...
                  _buildSubNavItem(
                    ...
                    title: 'Application Status (Convener)',
                    index: 13,
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ApplicationStatusConvenerPage(),
                        ),
                      );
                    },
                  ),
  ...
  Widget _buildSubNavItem(
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        if (onTap != null) {
          onTap();
          return; // Prevent further execution if custom onTap is provided
        }
