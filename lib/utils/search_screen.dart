...
class _SearchScreenState extends State<SearchScreen>
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: 0.95, end: 1.0).animate(
      CurvedAnimation(
        ...
        curve: const Interval(0.1, 0.9,
            curve: Curves.easeOutQuint), // Added interval for longer effect
      ),
    );
    ...
    _slideAnimation =
      ...
      CurvedAnimation(
        ...
        curve: const Interval(0.0, 0.8,
            curve: Curves.easeOutCubic), // Added interval for longer effect
      ),
    );
    ...
    _pulseAnimation = TweenSequence<double>([
      ...
      curve: const Interval(0.0, 0.7,
          curve: Curves.easeInOut), // Changed from 0.5 to 0.7
    ));
    ...
    Future.delayed(const Duration(milliseconds: 100), () {
      if (mounted) {
        _animationController.forward(
            from: 0.0); // Reset to ensure full animation
      }
    });
  }
  ...
  void _initializeModules() {
    ...
    _allModules.addAll([
      ...
      ModuleItem(
        ...
        route: (context) => const ProfileScreen(), // Placeholder
      ),
    ...
    _allSubModules.addAll([
      ...
      SubModuleItem(
        ...
        icon: Icons.info,
        color: Colors.blue,
        route: (context) => const ExampleScreen(),
        parentModule: 'Example Module',
    ...
    return GestureSidebar(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle:
              false, // Changed from true to false to align title to the left
      ...
      child: SafeArea(
        ...
        child: Padding(
          ...
          child: AnimatedContainer(
            duration:
                const Duration(milliseconds: 500), // Increased from 300 to 500
            curve: Curves.easeOutQuint,
            height: 50,
            decoration: BoxDecoration(
              color: Colors.white,
              ...
              boxShadow: [
                BoxShadow(
                  color:
                      Colors.black.withOpacity(_isSearchFocused ? 0.12 : 0.08),
                  blurRadius: _isSearchFocused ? 15 : 10,
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: AnimatedContainer(
                  duration: const Duration(
                      milliseconds: 500), // Increased from 300 to 500
                ...
                contentPadding: const EdgeInsets.only(
                    ...
                    top: 15,
                    right: 20,
                    bottom: 15), // Left padding removed, handled by prefixIcon
            ...
            child: Column(
              ...
              children: [
                ...
                TweenAnimationBuilder<double>(
                  ...
                  duration: const Duration(
                      milliseconds: 1200), // Increased from 800 to 1200
            ...
            itemBuilder: (context, index) {
              ...
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  final double startInterval = 0.1 +
                      (moduleIndex * 0.03 > 0.6
                          ? 0.6
                          : moduleIndex * 0.03); // Reduced from 0.05 to 0.03
                  final double endInterval = 0.7 +
                      (moduleIndex * 0.03 > 0.3
                          ? 0.3
                          : moduleIndex * 0.03); // Reduced from 0.05 to 0.03
              ...
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  final double startInterval =
                      0.1 + (index * 0.08 > 0.6 ? 0.6 : index * 0.08);
                  final double endInterval =
                      0.6 + (index * 0.08 > 0.4 ? 0.4 : index * 0.08);
          ...
          children: [
            ...
            if (matchingSubModules.isNotEmpty) ...[
              ...
              ListView.separated(
                ...
                itemCount: matchingSubModules.length > 3
                    ? 3
                    : matchingSubModules.length,
                ...
                itemBuilder: (context, index) {
                  return _buildSubModuleItemForSearch(
                      context, matchingSubModules[index], true);
                },
              ),
  ...
  Widget _buildSubModuleItemForSearch(
      BuildContext context, SubModuleItem subModule,
      [bool isInSearchResult = false]) {
    final String query = _searchController.text.toLowerCase();
    final bool isMatching =
        query.isNotEmpty && (subModule.name.toLowerCase().contains(query));
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            leading: Container(
              ...
              child: Icon(subModule.icon, color: Colors.white, size: 20),
            ),
            title: Text(
              subModule.name,
              style: const TextStyle(
...
class ExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('This is an example screen.'),
      ),
    );
  }
}
