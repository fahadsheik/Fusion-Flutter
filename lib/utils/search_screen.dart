...
import '../screens/SPACS/catalogue.dart';
import '../screens/SPACS/spacs_dashboard.dart';
import '../screens/SPACS/browse_applications.dart';
import '../screens/SPACS/application_status.dart'; 
import '../screens/SPACS/invite_applications.dart';
import '../screens/SPACS/catalogue_convenor.dart';
import 'bottom_bar.dart';
import '../screens/SPACS/application_status_convener.dart';
  ...
  void _initializeModules() {
    ...
    _allModules.add(
      ModuleItem(
        ...
        icon: Icons.star,
        color: Colors.blue.shade700,
        route: (context) => const SpacsDashboard(),
      ),
    );
    ...
    _allSubModules.addAll([
      SubModuleItem(
        ...
        icon: Icons.book,
        color: Colors.blue.shade700,
        route: (context) => const CataloguePage(),
        parentModule: 'SPACS',
        description: 'View scholarships and awards catalogue',
      ),
      SubModuleItem(
        name: 'Browse Applications',
        icon: Icons.folder_open,
        color: Colors.blue.shade700,
        route: (context) => const BrowseApplicationsPage(), // Updated route
        parentModule: 'SPACS',
      ...
      SubModuleItem(
        ...
        color: Colors.blue.shade700,
        route: (context) => const ApplicationStatusPage(), // Placeholder
        parentModule: 'SPACS',
        description: 'View status of applications submitted',
      ),
      SubModuleItem(
        name: 'Invite Applications',
        icon: Icons.how_to_reg,
        color: Colors.blue.shade700,
        route: (context) => const InviteApplicationsPage(), // Placeholder
        parentModule: 'SPACS',
        description: 'Allows faculty to send award application',
      ),
      SubModuleItem(
        name: 'Catalogue Convenor',
        icon: Icons.edit_document,
        color: Colors.blue.shade700,
        route: (context) => const CatalogueConvenorPage(),
        parentModule: 'SPACS',
        description: 'Manage scholarships and awards as a convenor',
      ),
      SubModuleItem(
        name: 'Application Status (Convener)',
        icon: Icons.assignment_ind,
        color: Colors.blue.shade700,
        route: (context) => const ApplicationStatusConvenerPage(),
        parentModule: 'SPACS',
        description: 'View and manage applications (Convener)',
      ),
    ]);
  }
